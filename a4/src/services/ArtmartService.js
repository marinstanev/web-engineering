export const ARTMART_BASE_URL = 'https://web-engineering.big.tuwien.ac.at/s24/a4';
export const ARTMART_BASE_WS_URL = 'ws://web-engineering.big.tuwien.ac.at/s24/a4';
//export const ARTMART_BASE_URL = 'http://localhost:3004';
//export const ARTMART_BASE_WS_URL = 'ws://localhost:3004';
...
export async function openSocket(endpoint) {
    return new Promise((resolve,reject) => {
        const socket = new WebSocket(ARTMART_BASE_WS_URL + endpoint)
